...
// -----------------------------------
// task2
let student_name=["arun","buvi","dhanu","sersha","dhana"];
...
// ------------------------------------------
// task4
let student=[{name:"arun",mark:70},{name:"bhuvi",mark:91},{name:"dhanu",mark:79},{name:"sersha",mark:95},{name:"dhana",mark:100}];
